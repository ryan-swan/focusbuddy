    ...
    <div className="fixed inset-0 z-[250] bg-black/40 flex items-center justify-center" onMouseDown={onClose}>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-[14px] font-semibold text-[var(--ink-90)]">Pick a starter slide</span>
            ...
            return (
              ...
              >
                ...
                <div className="px-2 py-1.5">
                  <div className="text-[12px] font-medium text-[var(--ink-70)]">{tpl.name}</div>
                  <div className="text-[11px] text-[var(--ink-40)] truncate">{tpl.description}</div>
                </div>
              </button>
            )
          })}
