    ...
    >
      ...
      <div className="flex items-center gap-2">
        {question.allowFreeText && (
          <span className="text-[10.5px] text-[var(--ink-50)]">
        ...
        <button
          ...
          className="h-[24px] px-2.5 rounded-full text-[11px] font-medium transition-colors bg-[rgb(var(--accent))] text-white hover:bg-[rgb(var(--accent-hover))] disabled:bg-[var(--surface-sunken)] disabled:text-[var(--ink-40)] disabled:border disabled:border-[var(--edge-soft)]"
        >
          Send
        </button>
      </div>
