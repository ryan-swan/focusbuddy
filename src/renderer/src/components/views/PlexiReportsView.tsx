...
export default function PlexiReportsView(): JSX.Element {
  ...
  useEffect(() => {
    ...
    void window.api.reports.runDue()
  }, [])
      ...
      <div className="w-[300px] shrink-0 border-r border-[var(--edge-soft)] flex flex-col">
        <div className="px-4 py-3.5 border-b border-[var(--edge-soft)]">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-[15px] font-bold tracking-tight">PlexiReports</h1>
          </div>
        ...
        <div className="flex-1 overflow-auto px-2 pb-2">
          {reports === null ? (
            ...
            <div className="px-3 py-10 text-center" data-testid="reports-empty">
              <Icon name="summarize" size={24} className="text-stone-300 dark:text-stone-600" />
      ...
      <div className="flex-1 min-w-0 overflow-auto">
        {selected ? (
          ...
          <div className="h-full flex flex-col items-center justify-center text-center px-6">
            <Icon name="summarize" size={30} className="text-stone-300 dark:text-stone-600" />
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-6">
      ...
      <input
        ...
        className="w-full bg-transparent text-[20px] font-bold text-[var(--ink-100)] outline-none placeholder:text-[var(--ink-50)] mb-4"
      />
