...
export const CAPABILITY_DEFAULTS: Record<string, Record<TierId, CapabilityValue>> = {
  ...
  multi_device_sync: { free: 2, pro: 'Unlimited', team: 'Unlimited' },
  ...
  office_comments: { free: false, pro: true, team: true },
  ...
  chat: { free: false, pro: true, team: true },
  meet: { free: false, pro: true, team: true },
  meet_schedule: { free: false, pro: true, team: true },
  calls: { free: false, pro: true, team: true },
  video_messages: { free: false, pro: true, team: true },
  knock: { free: false, pro: true, team: true },
  mail: { free: false, pro: true, team: true },
  ...
  live_collaboration: { free: false, pro: true, team: true },
  realtime_coediting: { free: false, pro: true, team: true },
