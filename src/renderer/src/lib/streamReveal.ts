...
// or an early finish is never repaid as a flood; the backlog reads out at
// this pace however it arrived.
export const REVEAL_CPS = 220
// Commit to React at most ~22fps. Per-frame reparses buy nothing visually and
// cost markdown parsing; the overlapping word fades carry the sense of
// continuous motion between commits.
