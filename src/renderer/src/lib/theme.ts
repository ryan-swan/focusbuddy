...
export const THEME_OPTIONS: Array<{ value: ThemeMode; label: string; icon: string }> = [
  ...
  // Material Desk — a rich dark-walnut desk surface. Wood grain, warm ambient
  // lamp-glow, and tactile depth. Canvas strings render as visible twine.
  // The "I'm actually sitting at a desk" theme.
