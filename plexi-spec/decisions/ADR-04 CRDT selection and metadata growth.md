...
# ADR-04 — CRDT selection and metadata growth

> [!danger] Status: **OPEN** · Severity: **High** · Required by: **Phase 1 design**
> This decision is unresolved. Do not implement around it. Do not let an implementation
> detail settle it by default.

**Risk:** [[Risk Register#PLX-RSK-04|PLX-RSK-04]]

## Context

See [[Risk Register#PLX-RSK-04|PLX-RSK-04]] in the risk register for the full statement of the
