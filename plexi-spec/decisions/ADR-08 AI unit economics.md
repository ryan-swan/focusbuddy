...
# ADR-08 — AI unit economics

> [!danger] Status: **OPEN** · Severity: **Critical** · Required by: **Phase 1 exit**
> This decision is unresolved. Do not implement around it. Do not let an implementation
> detail settle it by default.

**Risk:** [[Risk Register#PLX-RSK-05|PLX-RSK-05]]

## Context

See [[Risk Register#PLX-RSK-05|PLX-RSK-05]] in the risk register for the full statement of the
