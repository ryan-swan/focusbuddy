...
status: OPEN
severity: High
required_by: "first production Event"
risk: PLX-RSK-08
tags:
  - adr
  - open
...
# ADR-03 — Event partition key and ordering

> [!danger] Status: **OPEN** · Severity: **High** · Required by: **first production Event**
> This decision is unresolved. Do not implement around it. Do not let an implementation
> detail settle it by default.

**Risk:** [[Risk Register#PLX-RSK-08|PLX-RSK-08]]

## Context

See [[Risk Register#PLX-RSK-08|PLX-RSK-08]] in the risk register for the full statement of the
